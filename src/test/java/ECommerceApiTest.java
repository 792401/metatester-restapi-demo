...
public class ECommerceApiTest {
    ...
    public void testGetUserDetails() {
        ...
        // Test nested preferences with null values
        Boolean smsNotifications = response.jsonPath().get("preferences.notifications.sms");
        // Note: this field is null in our mock data, testing null handling
        
        // Test subscription features array
    ...
    public void testGetUsersList() {
        ...
        // Test various user statuses and roles
        ...
        // Test nullable avatar field (third user has null avatar)
